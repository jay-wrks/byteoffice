(function(){
  ...
  async function boot(){
    try{
      // CheerpOS' /str string-file area is flat. Load our runtime source
      // same-origin and rewrite only the two temporary Java source paths.
      ...
      // environment just like the original <script src="java-mode.js"> did.
      (0,eval)(source+'\n//# sourceURL=js/java/java-mode.patched.js');

      // These depend on the functions installed by java-mode.js, so preserve
      // the original order explicitly after the async source rewrite.
