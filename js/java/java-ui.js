(function(){
  ...
  function showJavaWin(){
    ...
    showModal(`<div class="win-sheet java-win-sheet">
      ...
      <div class="score-cards">
        <div><span>Source</span><b>${calls} ByteBot calls</b><em>Real Java 17</em><small>main() supplied by ByteOffice</small></div>
  ...
  window.showHelp=function(){
    showModal(`<div class="modal-heading"><span>JAVA HANDBOOK</span><h2>Programming Byte</h2></div><div class="help-copy">
      ...
      <p><b>Java is real:</b> use variables, fields, methods, helper classes, loops, conditions, arrays, collections, recursion and the Java standard library. The source is compiled inside the browser and executed by a Java 17 JVM.</p>
